...
@section('content')
    <div class="container-fluid px-0">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                <h1 class="text-dark mb-1">Tambah Jurusan</h1>
                <p class="text-muted mb-0">Masukkan data jurusan baru.</p>
            </div>
                        ...
                        <div class="col-12 col-lg-6">
                            ...
                            >
                                ...
                                @foreach ($akreditasiOptions as $akreditasi)
                                    <option value="{{ $akreditasi }}" @selected(old('akreditasi') === $akreditasi)>
                                        {{ $akreditasi }}
                                    </option>
                                @endforeach
                            </select>
